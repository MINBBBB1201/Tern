    ...
    <main className="min-h-screen bg-[#F4F7FC] text-foreground">
      ...
      <article className="mx-auto max-w-4xl px-5 py-10">
        ...
        {guide.floorGuide && guide.floorGuide.length > 0 && (
          <section className="mt-6 rounded-2xl border border-[#e1eaf6] bg-white p-6 shadow-sm">
            <h2 className="text-lg font-bold">Terminal layout</h2>
            <p className="mt-1 text-xs text-muted">
              Static facts only — exact walking routes and transfer requirements vary by ticket and airline, so check your boarding pass and terminal signage on the day.
            </p>
